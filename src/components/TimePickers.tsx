  ...
  return (
    <View style={{ marginBottom: 18 }}>
      ...
      <Modal visible={open} transparent animationType="fade" onRequestClose={() => setOpen(false)}>
        <Pressable style={{ flex: 1, backgroundColor: "rgba(18,22,28,0.6)", justifyContent: "flex-end" }} onPress={() => setOpen(false)}>
          <Pressable style={{ backgroundColor: tokens.surface, borderTopLeftRadius: radii.xxl, borderTopRightRadius: radii.xxl, maxHeight: "60%" }}>
...
export function ArrivalDatePicker({ value, onChange }: { value: Date; onChange: (d: Date) => void }) {
  ...
  return (
    <View style={{ marginBottom: 18 }}>
      ...
      <Modal visible={open} transparent animationType="fade" onRequestClose={() => setOpen(false)}>
        <Pressable style={{ flex: 1, backgroundColor: "rgba(18,22,28,0.6)", justifyContent: "flex-end" }} onPress={() => setOpen(false)}>
          <Pressable style={{ backgroundColor: tokens.surface, borderTopLeftRadius: radii.xxl, borderTopRightRadius: radii.xxl, padding: 16 }}>
